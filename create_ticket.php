...
<?php if (isset($_POST["create_ticket"])): ?>
    <?php $create_ticket = CreateTicket($_POST["ticket_name"], $_POST["ticket_description"], $_POST["users"], $_POST["jobs"], $_POST["ticket_status"], $_POST["date_due"]); ?>
<?php endif; ?>
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <h1 class="mt-4">Kreiraj radni nalog</h1>
            <?php if (isset($create_ticket) AND !empty($create_ticket)): ?>
                <?php if ($create_ticket != 1): ?>
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input name="ticket_name" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Unesite naziv radnog naloga (max. 50 znakova)" value="<?php if (!empty($_POST["ticket_name"])): echo $_POST["ticket_name"]; endif; ?>">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Početna bilješka</label>
                    <textarea name="ticket_description" class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Opišite nalog"><?php if (!empty($_POST["ticket_description"])): echo $_POST["ticket_description"]; endif; ?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        <input name="date_due" type="text" class="form-control" value="<?php if (!empty($_POST["date_due"])): echo $_POST["date_due"]; endif; ?>" id="js-date"/>
                ...
                <div class="form-group">
                    <input name="create_ticket" type="submit" class="btn btn-primary" value="Kreiraj nalog">
                </div>
            </form>
        </div>
    </div>
