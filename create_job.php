...
<?php if (isset($_POST["create_job"])): ?>
    <?php $create_job = CreateJob($_POST["job_name"], $_POST["job_description"], $_POST["job_status"]); ?>
<?php endif; ?>
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <h1 class="mt-4">Kreiraj posao</h1>
            <?php if (isset($create_job) AND !empty($create_job)): ?>
                <?php if ($create_job != 1): ?>
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input name="job_name" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Unesite naziv posla (max. 50 znakova)" value="<?php if (!empty($_POST["job_name"])): echo $_POST["job_name"] ; endif;?>">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Opis posla</label>
                    <textarea name="job_description" class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Opišite posao"><?php if (!empty($_POST["job_description"])): echo $_POST["job_description"] ; endif;?></textarea>
                </div>
                <div class="form-group">
                    ...
                    <select name="job_status" class="form-control" id="exampleFormControlSelect1">
                        <?php foreach ($statuses as $status): ?>
                            <?php $selected_status = $_POST["job_status"]; ?>
                ...
                <div class="form-group">
                   <input name="create_job" type="submit" class="btn btn-primary" value="Kreiraj posao" >
                </div>
            </form>
        </div>
    </div>
