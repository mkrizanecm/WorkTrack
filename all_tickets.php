...
<body>
<?php $tickets = GetAllTickets($_SESSION['privilege'], '', 0 , 0); ?>
<?php
    $results_per_page = 9;
...
<?php $tickets = GetAllTickets($_SESSION['privilege'], '', $page_result_number , $results_per_page); ?>
<?php if (isset($_POST['search'])): ?>
    <?php $tickets = GetAllTickets($_SESSION['privilege'], $_POST['search_value'], 0, $results_per_page); ?>
<?php endif; ?>
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <h1 class="mt-4">Svi radni nalozi</h1>
            <?php if ($_SESSION['privilege'] != 'staff'): ?>
                ...
                <?php else: ?>
                    ...
                    <?php if ($ticket['status'] == 'Zavrseno'): continue; endif; ?>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($active_ticket) AND $active_ticket == $ticket["id"]): ?>
                            ...
                            <td>
                                <?php if (strtotime($ticket["date_due"]) < strtotime(date('d-m-Y'))): ?>
                                    <span class="badge badge-danger"><?php echo date('d.m.Y', strtotime($ticket["date_due"])); ?></span>
                                <?php else: ?>
                                    <span class="badge badge-info"><?php echo date('d.m.Y', strtotime($ticket["date_due"])); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
            ...
            <ul class="pagination">
                <?php for ($page = 1; $page <= $page_number; $page++): ?>
                    <li class="page-item"><a class="page-link" href="all_tickets.php?page=<?php echo $page ?>"><?php echo $page; ?></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
