...
<body>
<?php $tickets = GetTickets($_SESSION['user'], '', 0, 0); ?>
        <?php
        $results_per_page = 9;
...
<?php $tickets = GetTickets($_SESSION['user'], '', $page_result_number, $results_per_page); ?>
<?php if (isset($_POST['search'])): ?>
    <?php $tickets = GetTickets($_SESSION['user'], $_POST['search_value'], 0 , $results_per_page); ?>
<?php endif; ?>
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <h1 class="mt-4">Tvoji radni nalozi</h1>
            <?php if ($_SESSION['privilege'] != 'staff'): ?>
            ...
            <ul class="pagination">
                <?php for ($page = 1; $page <= $page_number; $page++): ?>
                    <li class="page-item"><a class="page-link" href="tickets.php?page=<?php echo $page ?>"><?php echo $page; ?></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
